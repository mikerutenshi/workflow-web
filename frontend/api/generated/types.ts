...
export type ProductGroupGetDto = {
  ...
  productCategory: ProductCategory;
  productCategoryId: Scalars['ID']['output'];
  products?: Maybe<Array<Maybe<ProductWithColors>>>;
  skuNumeric: Scalars['String']['output'];
  updatedAt: Scalars['Date']['output'];
  updatedBy?: Maybe<Scalars['ID']['output']>;
};
...
export type GetProductGroupsQuery = { __typename?: 'Query', getProductGroups: Array<{ __typename?: 'ProductGroupGetDto', id: string, skuNumeric: string, name?: string | null, productCategory: { __typename?: 'ProductCategory', id: string, name: string, gender: Gender }, laborCosts?: Array<{ __typename?: 'LaborCost', id: string, type: string, cost: number, createdBy: string, createdAt: any, updatedBy?: string | null, updatedAt: any } | null> | null }> };
...
export type GetProductGroupQuery = { __typename?: 'Query', getProductGroup: { __typename?: 'ProductGroupGetDto', id: string, skuNumeric: string, name?: string | null, createdBy: string, updatedBy?: string | null, productCategory: { __typename?: 'ProductCategory', id: string, name: string, gender: Gender }, laborCosts?: Array<{ __typename?: 'LaborCost', id: string, type: string, cost: number, createdBy: string, createdAt: any, updatedBy?: string | null, updatedAt: any } | null> | null } };
...
export type GetProductQuery = { __typename?: 'Query', getProduct: { __typename?: 'ProductGetDto', id: string, sku: string, productGroup: { __typename?: 'ProductGroupWithCategory', id: string }, productColors: Array<{ __typename?: 'ColorToProductWithColor', order: number, color: { __typename?: 'Color', id: string } }> } };
...
export type WorkWithTasksFragment = { __typename?: 'WorkWithTasks', id: string, date: any, orderNo: number, productId: string, createdBy: string, updatedBy?: string | null, sizes: Array<{ __typename?: 'SizeToWork', quantity: number, size: { __typename?: 'Size', id: string, eu: string, us?: string | null, uk?: string | null } }>, tasks: Array<{ __typename?: 'TaskWithArtisan', id: string, createdBy: string, updatedBy?: string | null, workId: string, type: Job, doneAt?: any | null, artisan?: { __typename?: 'Artisan', id: string, firstName: string, lastName?: string | null, jobs: Array<Job>, createdBy: string, updatedBy?: string | null } | null }>, product: { __typename?: 'Product', sku: string } };

export type WorkFragment = { __typename?: 'WorkWithTasks', id: string, date: any, orderNo: number, productId: string, createdBy: string, updatedBy?: string | null, sizes: Array<{ __typename?: 'SizeToWork', quantity: number, size: { __typename?: 'Size', id: string, eu: string, us?: string | null, uk?: string | null } }>, product: { __typename?: 'Product', sku: string } };
...
export type GetWorkQuery = { __typename?: 'Query', getWork: { __typename?: 'WorkWithTasks', id: string, date: any, orderNo: number, productId: string, createdBy: string, updatedBy?: string | null, sizes: Array<{ __typename?: 'SizeToWork', quantity: number, size: { __typename?: 'Size', id: string, eu: string, us?: string | null, uk?: string | null } }>, product: { __typename?: 'Product', sku: string } } };
...
export type GetTasksQuery = { __typename?: 'Query', getTasks: Array<{ __typename?: 'TaskWithArtisan', id: string, createdBy: string, updatedBy?: string | null, workId: string, type: Job, doneAt?: any | null, artisan?: { __typename?: 'Artisan', id: string, firstName: string, lastName?: string | null, jobs: Array<Job>, createdBy: string, updatedBy?: string | null } | null }> };
...
export const UpsertLaborCostsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"upsertLaborCosts"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"data"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"LaborCostUpsertDto"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"upsertLaborCosts"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"data"},"value":{"kind":"Variable","name":{"kind":"Name","value":"data"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<UpsertLaborCostsMutation, UpsertLaborCostsMutationVariables>;
