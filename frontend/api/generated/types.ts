...
export type GetPayrollQuery = { __typename?: 'Query', getPayroll: { __typename?: 'PayrollGetDto', totalPayable: number, totalQuantity: number, artisans: Array<{ __typename?: 'ArtisanWithTasks', id: string, firstName: string, lastName?: string | null, payablePerArtisan: number, quantityPerArtisan: number, tasks: Array<{ __typename?: 'TaskWithWork', payablePerTask: number, costPerTask: number, quantityPerTask: number, type: Job, doneAt?: any | null, work: { __typename?: 'WorkWithProduct', orderNo: string, sizes: Array<{ __typename?: 'SizeToWork', quantity: number, size: { __typename?: 'Size', eu: string } }>, product: { __typename?: 'Product', sku: string } } }> }> } };
